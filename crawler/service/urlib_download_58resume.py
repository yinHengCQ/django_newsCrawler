...
def __get_dict(page):
    ...
    file = open('/root/django_newsCrawler/crawler/service/temp.ttf', 'wb')
    file.write(fontdata)
    file.close()
    # font = TTFont(r'C:\Users\Administrator\PycharmProjects\django_newsCrawler\crawler\service\temp.ttf')
    font = TTFont('/root/django_newsCrawler/crawler/service/temp.ttf')
    ...
    ft = ImageFont.truetype('/root/django_newsCrawler/crawler/service/temp.ttf', 300)
    temp_dict = {}
    ...
    for k, v in cmaps.items():
        ...
        im02 = Image.open("/root/django_newsCrawler/crawler/service/block.png")
...
def get_data(page):
    ...
    for var in path_list:
        try:resume_id = re.search(r'&dpid=(.+)&', var.xpath('div[@class="fl"][1]/dl[1]/dt[1]/a[1]/@href')[0]).group(1)
        except:resume_id=''
        try:name = var.xpath('@username')[0].encode('utf-8')
        except:name=''
        try:sex = var.xpath('div[@class="fl"][1]/dl[1]/dd[1]/div[1]/a[1]/div[1]/div[1]/em[1]/text()')[0].encode('utf-8')
        except:sex=''
        try:age = var.xpath('div[@class="fl"][1]/dl[1]/dd[1]/div[1]/a[1]/div[1]/div[1]/em[2]/text()')[0].replace(u'三',u'3').encode('utf-8')
        except:age=''
        try:work_age = var.xpath('div[@class="fl"][1]/dl[1]/dd[1]/div[1]/a[1]/div[1]/div[1]/em[3]/text()')[0].replace(u'三',u'3').encode('utf-8')
        except:work_age=''
        try:
            education = var.xpath('div[@class="fl"][1]/dl[1]/dd[1]/div[1]/a[1]/div[1]/div[1]/em[4]/text()')[0].replace(u'口中',u'高中')\
                .replace(u'..专', u'中专').replace(u'局..', u'高中').encode('utf-8')
        except:education=''
