...
class job51(models.Model):
    ...
    job_url=models.CharField(max_length=300,null=True)
    ...
    job_salary=models.CharField(max_length=20,null=True)
...
class JobDetail(models.Model):
    ...
    job_detail_desc=models.CharField(max_length=5000,null=True)
    job_type_desc=models.CharField(max_length=300,null=True)
    job_keyword_desc = models.CharField(max_length=300,null=True)
